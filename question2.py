...
<html lang="en-gb"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./question2_files/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="./question2_files/jquery.typeahead.min.css" type="text/css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    
    <link rel="stylesheet" href="./question2_files/style.min.css" type="text/css">
    
    <link rel="stylesheet" href="./question2_files/custom.css" type="text/css">
    <script src="./question2_files/promise.min.js.download" type="text/javascript" charset="utf-8"></script>
    <script src="./question2_files/react.production.min.js.download" type="text/javascript"></script>
    <script src="./question2_files/react-dom.production.min.js.download" type="text/javascript"></script>
    <script src="./question2_files/index.js.download" type="text/javascript"></script>
    <script src="./question2_files/require.js.download" type="text/javascript" charset="utf-8"></script>
    <script>
      require.config({
...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="services/contents" src="./question2_files/contents.js.download"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom/custom" src="./question2_files/custom.js.download"></script></head>
...
<div id="header" role="navigation" aria-label="Top Menu" style="display: block;">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="http://localhost:8888/tree?token=fec61819c0b1c2c5e83711d13b7cca54ca648714a3138eb0" title="dashboard">
      <img src="./question2_files/logo.png" alt="Jupyter Notebook">
  </a></div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class=" collapse in">
                <div class="panel-body">
                  ...
                  <div class="list_item row"><div class="col-md-12"><i class="item_icon running_notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/question2.ipynb" target="_blank"><span class="item_name">question2.ipynb</span></a><div class="pull-right"><div class="item_buttons pull-left"><div class="kernel-name">Python 3</div><button class="btn btn-warning btn-xs">Shutdown</button></div><div class="pull-right"><span class="item_modified pull-left" title="2021-10-03 13:16">seconds ago</span><span class="file_size pull-right">&nbsp;</span></div></div></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<script src="./question2_files/main.min.js.download" type="text/javascript" charset="utf-8"></script>
